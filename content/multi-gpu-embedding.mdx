...
date: '2024-11-26'
thumbnail: /multi-gpu-embedding/hero_1.png
---

## Introduction

In the previous [blog](https://jianliao.github.io/blog/clip-vit-fine-tune), I covered fine-tuning a CLIP model for Adobe Design UI icons to enhance searchability. Now, I scale up to generate embeddings using multiple GPUs, which presents several new challenges, particularly around optimizing efficiency in multi-GPU setups.
...
![Hero Image of the blog](/multi-gpu-embedding/hero_2.png)

### **Getting Started: Setting Up for Parallel Processing**

#### Hardware Configuration:

- **CPU:** [AMD EPYC™ 7282](https://www.amd.com/en/support/downloads/drivers.html/processors/epyc/epyc-7002-series/amd-epyc-7282.html) - 16 Cores, 32 Threads @ 2.8 GHz
...
![Batch Size vs Time](/multi-gpu-embedding/batch_size_vs_time.png)
...
![DataLoader Workers vs Time](/multi-gpu-embedding/num_workers_vs_time.png)
...
![Number of GPUs vs Time](/multi-gpu-embedding/num_gpu_vs_time.png)
...
![Speedup Chart](/multi-gpu-embedding/speedup.png)
