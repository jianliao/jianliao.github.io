...
export const metadata = {
  title: "Figma ➜ SigLIP2: Lessons from Finetuning an Icon Encoder End-to-End (Part 1)",
  description:
    "An end-to-end journey of building a SigLIP2-based icon encoder — from harvesting icons in Figma, cleaning design-system data, and synthesizing captions with LLMs to releasing a production-ready model on Hugging Face.",
  openGraph: {
    title: "Figma ➜ SigLIP2: Lessons from Finetuning an Icon Encoder End-to-End (Part 1)",
    description:
...
<BlogHeader title="Figma ➜ Finetuned SigLIP2 ViT Icon Encoder" subtitle="Lessons from Finetuning an Icon Encoder End-to-End (Part 1)" postDate="2025-11-28" />

<Image src={heroimage} alt="Figma ➜ SigLIP2: Lessons from Finetuning an Icon Encoder End-to-End (Part 1)" />
...
One of the nicest surprises in this project was Figma’s API design.
