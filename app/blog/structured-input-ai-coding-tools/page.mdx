...
import singleSelectionImage from './single-selection.png';
import multiSelectionImage from './multi-selection.png';
...
<Image src={singleSelectionImage} alt="Claude Code AskUserQuestion single-selection UI showing character race options with tabbed navigation" />
...
<Image src={multiSelectionImage} alt="Claude Code AskUserQuestion multi-selection UI showing skill checkboxes with multiple selections" />
